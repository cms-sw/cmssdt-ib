    ...
    statusLabelsConfigs: [
        ...
        },
        {
            ...
            getUrl: function (ib, result) {
                return "https://cmssdt.cern.ch/circles/web/piechart.html?local=false&dataset="+ getCurrentIbTag(ib)+"/" + result.arch + "%2F23434.21%2Fstep3_RAW2DIGI_L1Reco_RECO_RECOSIM_PU.resources&resource=time_thread&colours=default&groups=reco_PhaseII&threshold=0";
            }
        },
        {
            ...
            getUrl: function (ib, result) {
                return "https://cmssdt.cern.ch/SDT/jenkins-artifacts/igprof/"
                    + getCurrentIbTag(ib) + "/" + result.arch + "/profiling/23434.21/sorted_RES_CPU_step3.txt";
            }
        },
        {
